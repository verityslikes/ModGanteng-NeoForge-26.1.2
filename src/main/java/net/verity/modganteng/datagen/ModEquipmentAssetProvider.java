...
public class ModEquipmentAssetProvider implements DataProvider {
    ...
    private static void bootstrap(BiConsumer<ResourceKey<EquipmentAsset>, EquipmentClientInfo> output) {
        output.accept(ModArmorMaterials.VALDERIUM_KEY, EquipmentClientInfo.builder()
                .addHumanoidLayers(Identifier.fromNamespaceAndPath(ModGanteng.MOD_ID, "valderium"), false)
                .build());
    }
    ...
    public String getName() {
        return "ModGanteng Equipment Definitions";
    }
}